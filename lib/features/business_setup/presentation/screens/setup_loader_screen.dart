...
//         subtitle: setupState.businessName.isNotEmpty
//             ? setupState.businessName
//             : '${storeType.label} Store',
//       ),
//       _SetupTask(
//         icon: '💳',
//         title: 'Setting up payment methods',
//         subtitle: setupState.selectedPaymentMethods
//             .map((m) => m.label)
//             .join(', '),
//       ),
//       _SetupTask(
...
//         subtitle: storeType.defaultCategories.take(3).join(', ') + '...',
//       ),
//       _SetupTask(
//         icon: '⚙️',
//         title: 'Configuring your settings',
//         subtitle: 'Credit, units & currency',
//       ),
//       _SetupTask(
//         icon: '✅',
//         title: 'Almost ready!',
...
//       if (!mounted) return;
//
//       // TODO: Execute actual local DB operations here per task:
//       // i==0: BusinessRepository.createBusiness(setupState)
//       // i==1: BusinessRepository.createPaymentMethods(setupState)
//       // i==2: BusinessRepository.createCategories(setupState)
//       // i==3: BusinessRepository.saveSettings(setupState)
//
//       setState(() {
//         _tasks[i].completed = true;
...
class _SetupLoaderScreenState extends ConsumerState<SetupLoaderScreen>
  ...
  Future<void> _runSetup() async {
    ...
    if (setupState.setupStatus == SetupStatus.success) {
      ...
      if (!mounted) return;
      context.go('/bottomnavbar'); // Routes.BOTTOMNAVBAR
    }
