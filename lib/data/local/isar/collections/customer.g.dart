...
extension CustomerQueryWhereSort on QueryBuilder<Customer, Customer, QWhere> {
  ...
  QueryBuilder<Customer, Customer, QAfterWhere> anySyncStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryWhere on QueryBuilder<Customer, Customer, QWhereClause> {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> syncStatusEqualTo(
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> syncStatusNotEqualTo(
    SyncStatus syncStatus,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> syncStatusGreaterThan(
    SyncStatus syncStatus, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> syncStatusLessThan(
    SyncStatus syncStatus, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterWhereClause> syncStatusBetween(
